...
public class RepositoriosPostgreSQLTest
{
    ...
    public void SaveOrUpdateCliente_NuevoCliente_CreaCliente()
    {
        ...
        var resultado = repo.SaveOrUpdateCliente(new Cliente { Id = nuevoId, Nombre = "Cliente Test PostgreSQL" });

        Assert.True(resultado);
        var guardado = repo.GetCliente(nuevoId);
        Assert.NotNull(guardado);
        Assert.Equal("Cliente Test PostgreSQL", guardado.Nombre);
    }
    ...
    public void SaveOrUpdateProducto_NuevoProducto_CreaProducto()
    {
        ...
        {
            Id = nuevoId,
            Nombre = "Producto Test PostgreSQL",
            Descripcion = "Test",
            Precio = 99.99m,
        ...
        Assert.NotNull(guardado);
        Assert.Equal("Producto Test PostgreSQL", guardado.Nombre);
    }
